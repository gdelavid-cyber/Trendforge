        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 pb-6 border-b border-white/10">
          <div>
            <div className="flex items-center gap-4">
              {/* 3D Swarm Sentinel Stage */}
              <div className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-2xl p-1 bg-gradient-to-br from-cyan-500/20 via-indigo-600/20 to-purple-600/20 border border-cyan-400/40 shadow-[0_0_20px_rgba(0,240,255,0.25)] overflow-hidden shrink-0">
                {/* 3D WebGL Bot */}

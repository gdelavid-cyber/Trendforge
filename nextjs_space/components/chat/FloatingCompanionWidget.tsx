      ...
      <div className="fixed bottom-6 right-6 z-[999] flex flex-col items-end gap-3 pointer-events-auto">
        ...
        >
          ...
          <div className="w-16 h-16 rounded-full bg-[#08080E] p-0.5 flex items-center justify-center overflow-hidden relative shadow-inner">
            ...
            {/* Live / Running Badge */}
            <span
              className={`absolute bottom-0.5 right-0.5 z-20 w-4 h-4 rounded-full border-2 border-black flex items-center justify-center shadow-lg ${
          ...
          {/* Tooltip Tag */}
          <span className="absolute -top-8 right-0 text-[10px] font-mono font-bold uppercase bg-black/90 text-[#00F0FF] px-2.5 py-1 rounded-full border border-[#00F0FF]/40 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-[0_0_15px_rgba(0,240,255,0.3)] backdrop-blur-md">
            Talk to Agent 🎙️
          </span>
        </motion.button>
      </div>
